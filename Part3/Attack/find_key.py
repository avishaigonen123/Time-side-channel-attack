...
def is_negative_in_special_modulo(point, ogP):
    ...
    return numerator*denominator < 0 # "numerator*denominator < 0", it enters the if only when this is negative'
...
<<<<<<< HEAD
        ...
        # key_bits = key_bits + [realKey[index]] 
        # index += 1
...
def main():
    ...
    path = r'C:\Users\avish\OneDrive\Documents\PlatformIO\Projects\Time side channel attack\Part3\Attack\S_2_3_193939_0xCD_2024-07-07_19-42-28.txt'
